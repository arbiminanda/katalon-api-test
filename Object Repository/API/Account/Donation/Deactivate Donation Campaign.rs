...
<WebServiceRequestEntity>
   ...
   <name>Deactivate Donation Campaign</name>
   <tag></tag>
   <elementGuidId>1d3a9238-2ad1-4beb-8fb7-5b5f29ea4ed0</elementGuidId>
   ...
   <restUrl>${ipAccount}/backoffice/donation-account-agency/${id}/deactive</restUrl>
