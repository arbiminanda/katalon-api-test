...
<WebServiceRequestEntity>
   ...
   <name>List Donation Campaign</name>
   <tag></tag>
   <elementGuidId>ce5baf74-5cd1-45e5-93ba-958048690183</elementGuidId>
   ...
   <restUrl>${ipAccount}/backoffice/donation-account-agency?page=0&amp;size=10&amp;status=PENDING&amp;search=${code}</restUrl>
